  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full px-6">
      ...
      <div
        ...
        className={`bg-white rounded-2xl shadow-sm min-h-[64px] min-w-[120px] flex items-center justify-center text-4xl font-bold ${displayColor}`}
      >
        {displayValue}
      </div>
      ...
      <div role="group" aria-label="Number pad" className="grid grid-cols-3 gap-4">
        ...
        <button
          ...
          className="bg-white rounded-xl shadow-sm min-h-[64px] min-w-[64px] flex items-center justify-center active:opacity-80"
          style={{ touchAction: 'manipulation' }}
          disabled={phase === 'revealing'}
          onClick={() => {
            if (phase !== 'answering') return
